      ...
      try {
        ...
        const commentsWithReplies = await Promise.all(
          commentsData.map(async (c) => {
            try {
              const repliesRes = await getReplies(c._id)
              return { ...c, replies: repliesRes.data.data }
            } catch (err) {
              console.error(err)
              return { ...c, replies: [] }
            }
    ...
    <>
      <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
        <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
          ...
          <h4 className="_feed_inner_timeline_post_title">{post.caption}</h4>
            ...
            <div className="_timline_comment_main">
              {comments.length > visibleCount && (
                <div className="_previous_comment">
                  ...
                  >
                    View {comments.length - visibleCount} previous comments
                  </button>
                </div>
              )}
                ...
                comments.slice(0, visibleCount).map((comment) => (
                  <div className="_comment_main" key={comment._id}>
                    ...
                    <div className="_comment_area">
                      ...
                      {/* ---------- REPLIES LIST (reusing comment markup) ---------- */}
                      {(comment.replies || []).map((reply) => (
                        <div className="_comment_main" key={reply._id}>
                          <div className="_comment_image">
                            <a
                              href="profile.html"
